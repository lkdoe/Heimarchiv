...
WHITE = (255, 255, 255)  # White Color for the screen background
BLACK = (0, 0, 0)
RED = (255, 0, 0)
YELLOW = (255, 255, 0)
...
BULLET_HIT_SOUND = pygame.mixer.Sound(os.path.join(
    'Assets', 'Assets_Grenade+1.mp3'))
BULLET_FIRE_SOUND = pygame.mixer.Sound(os.path.join(
    'Assets', 'Assets_Gun+Silencer.mp3'))
...
def draw_winner(text):
    ...
    pygame.display.update()
    pygame.time.delay(5000)  # Pauses the game for 5000 ms
